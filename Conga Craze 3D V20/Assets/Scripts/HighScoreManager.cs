...
public class HighScoreManager : MonoBehaviour {
    ...
    void Start()
    {
        ...
        highScoreText.transform.position = new Vector3(3f, 10, 89);
    ...
    //Sets up the high score every time the game ends and shows the high score in one part of the arena
    //Changes once the high score is reached if the player beats the record.
